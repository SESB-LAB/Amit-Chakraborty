...
The third equation describes the dynamics of phosphorylated NRT1.1, which we call NRT1.1P. It is based on the responses comming NRT1.1 and the CBL9.CIPK23 complex. These responses forming a gate function and are integrated by this particular equation (please see our paper: Rashid et al., (2019). Feedforward control of plant nitrate transporter NRT1.1 biphasic adaptive activity. Biophy J.). 

INPUT:

The input to the model is nitrate concentration (NI) ranging from 0.1 mM to 25 mM. These values are taken from Ho et al. (2009). NRT1.1 functions aa a nitrate sensor. Cell. 
